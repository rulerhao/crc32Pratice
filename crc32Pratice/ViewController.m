...
//    NSString *UUIDString = @"091cca66-181c-11eb-8cca-0242ac160004";
    NSString *UUIDString = @"7da0f976-f732-11ea-b7aa-0242ac160004";
    ...
    NSString *TimeString = [NSString stringWithFormat:@"%02lx", (long)Time];
    NSLog(@"TimeString = %@", TimeString);
    
    
    NSMutableString *SerialString = [[NSMutableString alloc] init];
    [SerialString appendString:CRC32HexString];
    [SerialString appendString:@"0"];
    [SerialString appendString:TimeString];
    NSString *SerialStringUppercase = [SerialString uppercaseString];
    NSLog(@"SerialString = %@", SerialStringUppercase);
}
